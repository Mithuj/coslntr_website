    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 items-start justify-start rounded-2xl border border-white/[0.1] bg-black p-4 shadow-[0_8px_16px_rgb(0_0_0/0.4)] transition duration-700 overflow-hidden group-hover/pin:border-white/[0.2]"
        >

...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Beyond AI, we provide comprehensive custom software development—including web apps, mobile apps, and IoT software—designed to meet diverse client requirements. From concept to deployment, our agile development approach ensures robust, scalable, and user-friendly applications that drive business growth. Our IoT expertise enables smart device integration, facilitating automation and data-driven decisions across industries.",
      features: [
        "Custom web and mobile app development",
        "IoT software development and smart device integration",
        "Agile development methodology",
        "Scalable and user-friendly application delivery",
      ],
      ctaLabel: "View More",

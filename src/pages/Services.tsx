  ...
  const services = [
    {
      ...
      description: "Transform your business operations with intelligent automation that reduces manual work and increases efficiency. We build custom automation workflows tailored to your specific needs.",
      features: [
        "Process Automation",
    ...
    {
      icon: Brain,
      title: "AI-based R&D Services",
      description: "Leverage the power of artificial intelligence for research and development. Our AI software development services help you stay ahead of the competition with cutting-edge solutions.",
      features: [
    ...
    {
      icon: Lightbulb,
      title: "AI-based Research Solutions",
      description: "Advanced research solutions powered by AI to help you make data-driven decisions and unlock insights from complex datasets.",
      features: [
        "Data Analysis",
        "Pattern Recognition",
        "Sentiment Analysis",
    ...
    },
    {
      ...
      description: "Build powerful and scalable e-commerce platforms that drive sales and deliver exceptional customer experiences.",
      features: [
    ...
    },
    {
      ...
      description: "Specialized healthcare technology solutions including tele-medicine platforms, patient management systems, and health monitoring applications.",
      features: [
    ...
    },
    {
      ...
      description: "Tailored software solutions designed to meet your unique business requirements with modern technologies and best practices.",
      features: [
        "Web Applications",
        "Mobile Apps",
        "API Development",
